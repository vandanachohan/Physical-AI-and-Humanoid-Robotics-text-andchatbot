...
If you'd like any concept explained in Urdu, just ask!`),d(!1),o}},b=async()=>{if(""===r.trim())return;let e={id:i.length+1,text:r,sender:"user",timestamp:new Date};a(t=>[...t,e]),l("");let t=await m(r),o={id:i.length+2,text:t,sender:"tutor",timestamp:new Date};a(e=>[...e,o])};return e?(0,n.jsxs)("div",{className:"fixed bottom-6 right-6 z-50",children:[!t&&n.jsx("button",{onClick:h,className:"flex items-center justify-center w-16 h-16 bg-[#332a52] text-white rounded-full shadow-lg hover:bg-[#4f46e5] transition-all duration-300 transform hover:scale-105","aria-label":"Open AI Tutor",children:n.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-8 w-8",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:n.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"})})}),t&&(0,n.jsxs)("div",{className:"w-80 h-[500px] flex flex-col bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden transform transition-all duration-300 z-10",children:[(0,n.jsxs)("div",{className:"bg-[#332a52] text-white p-4 flex justify-between items-center",children:[(0,n.jsxs)("div",{children:[n.jsx("h3",{className:"font-bold",children:"AI Tutor"}),n.jsx("p",{className:"text-xs opacity-80",children:"Physical AI & Robotics"})]}),n.jsx("button",{onClick:h,className:"text-white hover:text-gray-200 focus:outline-none","aria-label":"Close chat",children:n.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-5 w-5",viewBox:"0 0 20 20",fill:"currentColor",children:n.jsx("path",{fillRule:"evenodd",d:"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z",clipRule:"evenodd"})})})]}),(0,n.jsxs)("div",{className:"flex-1 overflow-y-auto p-4 bg-gray-50 max-h-[350px]",children:[i.map(e=>n.jsx("div",{className:`mb-3 flex ${"tutor"===e.sender?"justify-start":"justify-end"}`,children:(0,n.jsxs)("div",{className:`max-w-[80%] rounded-2xl p-3 ${"tutor"===e.sender?"bg-[var(--tutor-bubble)] text-gray-800 rounded-tl-none":"bg-[var(--user-bubble)] text-gray-800 rounded-tr-none"}`,children:[n.jsx("div",{className:"text-xs font-semibold mb-1",children:"tutor"===e.sender?"AI Tutor":"You"}),n.jsx("div",{className:"text-sm whitespace-pre-wrap",children:e.text}),n.jsx("div",{className:"text-xs opacity-70 mt-1 text-right",children:e.timestamp.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})})]})},e.id)),c&&n.jsx("div",{className:"mb-3 flex justify-start",children:(0,n.jsxs)("div",{className:"max-w-[80%] rounded-2xl p-3 bg-[var(--tutor-bubble)] text-gray-800 rounded-tl-none",children:[n.jsx("div",{className:"text-xs font-semibold mb-1",children:"AI Tutor"}),(0,n.jsxs)("div",{className:"flex space-x-1",children:[n.jsx("div",{className:"w-2 h-2 rounded-full bg-gray-500 animate-bounce"}),n.jsx("div",{className:"w-2 h-2 rounded-full bg-gray-500 animate-bounce",style:{animationDelay:"0.2s"}}),n.jsx("div",{className:"w-2 h-2 rounded-full bg-gray-500 animate-bounce",style:{animationDelay:"0.4s"}})]})]})}),n.jsx("div",{ref:u})]}),n.jsx("div",{className:"border-t border-gray-200 p-3 bg-white",children:(0,n.jsxs)("div",{className:"flex",children:[n.jsx("input",{value:r,onChange:e=>l(e.target.value),onKeyPress:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),b())},placeholder:"Ask about robotics...",className:"flex-1 border border-gray-300 rounded-l-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#332a52] focus:border-[#332a52]"}),n.jsx("button",{onClick:b,disabled:c||""===r.trim(),className:`bg-[#332a52] text-white px-4 rounded-r-lg font-medium text-sm ${c||""===r.trim()?"opacity-50 cursor-not-allowed":"hover:bg-[#4f46e5] transition-colors"}`,children:"Send"})]})})]})]}):null}},3414:(e,t,o)=>{"use strict";o.r(t),o.d(t,{default:()=>s});var n=o(997);o(6764);let s=function({Component:e,pageProps:t}){return n.jsx(e,{...t})}},5949:(e,t,o)=>{"use strict";o.r(t),o.d(t,{default:()=>i});var n=o(997),s=o(6859);function i(){return(0,n.jsxs)(s.Html,{lang:"en",children:[n.jsx(s.Head,{}),(0,n.jsxs)("body",{children:[n.jsx(s.Main,{}),n.jsx(s.NextScript,{})]})]})}},6764:()=>{}};