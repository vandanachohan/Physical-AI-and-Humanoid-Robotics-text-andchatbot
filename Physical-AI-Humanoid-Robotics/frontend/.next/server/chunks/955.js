...
If you'd like any concept explained in Urdu, just ask!`),r(!1),o}},h=async()=>{if(""===o.trim())return;let s={id:e.length+1,text:o,sender:"user",timestamp:new Date};t(e=>[...e,s]),i("");let n=await d(o),a={id:e.length+2,text:n,sender:"tutor",timestamp:new Date};t(e=>[...e,a])};return(0,s.jsxs)("div",{className:"chat-container",children:[(0,s.jsxs)("div",{className:"chat-header",children:[s.jsx("h2",{className:"text-xl font-bold",children:"Physical AI & Humanoid Robotics Tutor"}),s.jsx("p",{className:"text-indigo-200 text-sm",children:"AI-powered assistance for your textbook"})]}),(0,s.jsxs)("div",{className:"chat-messages",children:[e.map(e=>s.jsx("div",{className:`message ${"tutor"===e.sender?"message-tutor":"message-user"}`,children:(0,s.jsxs)("div",{className:`message-bubble ${"tutor"===e.sender?"message-bubble-tutor":"message-bubble-user"}`,children:[s.jsx("div",{className:"message-sender",children:"tutor"===e.sender?"AI Tutor (رُوبوٹ ٹیوٹر)":"You (آپ)"}),s.jsx("div",{className:"message-text",children:e.text}),s.jsx("div",{className:"message-time",children:e.timestamp.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})})]})},e.id)),a&&s.jsx("div",{className:"message message-tutor",children:(0,s.jsxs)("div",{className:"message-bubble message-bubble-tutor",children:[s.jsx("div",{className:"message-sender",children:"AI Tutor (رُوبوٹ ٹیوٹر)"}),(0,s.jsxs)("div",{className:"loading-indicator",children:[s.jsx("div",{className:"loading-dot"}),s.jsx("div",{className:"loading-dot"}),s.jsx("div",{className:"loading-dot"})]})]})}),s.jsx("div",{ref:c})]}),(0,s.jsxs)("div",{className:"input-area",children:[(0,s.jsxs)("div",{className:"input-form",children:[s.jsx("textarea",{value:o,onChange:e=>i(e.target.value),onKeyPress:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),h())},placeholder:"Ask a question about Physical AI & Humanoid Robotics...",className:"input-textarea"}),s.jsx("button",{onClick:h,disabled:a||""===o.trim(),className:"send-button",children:"Send"})]}),s.jsx("div",{className:"example-queries",children:'Example: "How do humanoid robots balance on two legs?" or "Explain actuators and their types"'})]})]})}},531:(e,t,o)=>{o.d(t,{Z:()=>l});var s=o(997),n=o(6689),i=o(5198),a=o(1664),r=o.n(a);let c=()=>{let[e,t]=(0,n.useState)(!1);return(0,s.jsxs)("nav",{className:"bg-white shadow-lg fixed w-full z-40 top-0",children:[s.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,s.jsxs)("div",{className:"flex justify-between h-16",children:[s.jsx("div",{className:"flex items-center",children:s.jsx(r(),{href:"/",className:"flex-shrink-0 flex items-center",children:s.jsx("span",{className:"text-[#332a52] font-bold text-xl",children:"Physical AI & Robotics"})})}),(0,s.jsxs)("div",{className:"hidden md:flex items-center space-x-8",children:[s.jsx(r(),{href:"/",className:"text-gray-700 hover:text-[#332a52] font-medium transition-colors",children:"Home"}),s.jsx(r(),{href:"/tutorials",className:"text-gray-700 hover:text-[#332a52] font-medium transition-colors",children:"Tutorials"}),s.jsx(r(),{href:"/ai-tutor",className:"text-gray-700 hover:text-[#332a52] font-medium transition-colors",children:"AI Tutor"})]}),s.jsx("div",{className:"md:hidden flex items-center",children:(0,s.jsxs)("button",{onClick:()=>t(!e),className:"inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-[#332a52] focus:outline-none",children:[s.jsx("svg",{className:`${e?"hidden":"block"} h-6 w-6`,xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:s.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})}),s.jsx("svg",{className:`${e?"block":"hidden"} h-6 w-6`,xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:s.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})]})})]})}),s.jsx("div",{className:`${e?"block":"hidden"} md:hidden`,children:(0,s.jsxs)("div",{className:"px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg",children:[s.jsx(r(),{href:"/",className:"block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-[#332a52] hover:bg-gray-50",children:"Home"}),s.jsx(r(),{href:"/tutorials",className:"block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-[#332a52] hover:bg-gray-50",children:"Tutorials"}),s.jsx(r(),{href:"/ai-tutor",className:"block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-[#332a52] hover:bg-gray-50",children:"AI Tutor"})]})})]})},l=({children:e,showAIChatbot:t=!0})=>(0,s.jsxs)("div",{className:"relative min-h-screen bg-[var(--background-color)]",children:[s.jsx(c,{}),s.jsx("main",{className:"pt-16 pb-24",children:e}),t&&s.jsx(i.Z,{})]})}};